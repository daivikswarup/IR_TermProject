...
def writetofile(link,fcount):
	...
	#print "here"
	#print comments
	f=open("/home/daivik/IR/NDTV/Opinion/Comments_"+str(fcount),"w")
	for comment in comments:
		print>>f,(comment.encode('utf8')+'\n')
	f.close()
	f=open("/home/daivik/IR/NDTV/Opinion/Article_"+str(fcount),"w")
		...
		try:
			...
			for link in soup.find_all('a'):
				...
				if(strin and not strin in dict):
					dict[strin]=1
					if(strin.startswith("http://www.ndtv.com/opinion/")):
						urls.append(strin)

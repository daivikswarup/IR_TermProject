...
def writetofile():
	...
	baseurl="http://www.theatlantic.com/international/"
	#finished=[]
	urls.append(baseurl)
	while(len(urls)>0):
		url=urls.pop()
				...
				try:
					...
					for link in soup.find_all('a'):
						...
						if(strin and not strin in dict):
							dict[strin]=1
							#print strin
							if((strin.startswith('/international/'))):
								#print "x"
	...
	#print "y"
			...
			#print "c"
				if(len(comments)>0):
					f=open("/home/daivik/IR/atlantic/world/Comments_"+str(cnt),"w")
					for comment in comments:
						...
						#print>>f,("_____________")
							...
							pass
					f.close()
					f=open("/home/daivik/IR/atlantic/world/Article_"+str(cnt),"w")

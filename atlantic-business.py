...
def writetofile():
	...
	baseurl="http://www.theatlantic.com/business/"
	#finished=[]
	urls.append(baseurl)
	while(len(urls)>0):
		url=urls.pop()
	...
	#print "y"
			...
			#print "c"
				if(len(comments)>0):
					f=open("/home/daivik/IR/atlantic/business/Comments_"+str(cnt),"w")
					for comment in comments:
						...
						#print>>f,("_____________")
							...
							pass
					f.close()
					f=open("/home/daivik/IR/atlantic/business/Article_"+str(cnt),"w")
